...
`cks-runtime` provides the infrastructure to execute, manage, version, persist, and expose Canonical Knowledge Structures without becoming a semantic authority itself. Fully async, with PostgreSQL support alongside SQLite. Currently at **<PackageVersion repo="cks-runtime" prefix />**.
