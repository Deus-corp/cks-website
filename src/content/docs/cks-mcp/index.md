...
It exposes **24 tools** over MCP, backed by the deterministic, immutable
...
| [Tools Reference](tools/index.md) | All 24 tools, grouped by function, with request/response examples |
