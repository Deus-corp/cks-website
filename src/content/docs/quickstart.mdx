...
- Browse the [Tools Reference](/cks-website/cks-mcp/tools/) — all <ToolCount /> tools,
  grouped by what they're for, with request/response examples.
- Explore the [cks-core](/cks-website/cks-core/) semantic engine.
- Learn about [cks-runtime](/cks-website/cks-runtime/) sessions and version history.
- Read the [Architecture](/cks-website/cks-mcp/architecture/architecture/) and
  [Security Model](/cks-website/cks-mcp/security/) of the MCP server.
- Set up [cks-studio](/cks-website/cks-studio/) for a visual,
